...
#streamlit run "/Users/knk_macbookair/Downloads/Data Science/Capstone05/project5.py"
...
if selected == "Flat Resale Price Prediction":
    ...
    if button:
        ...
        if not all([user_month,user_town,user_flat_type,user_flat_model,floor_area_sqm,price_per_sqm,year,block,
            ...
            with open('/Users/knk_macbookair/Downloads/Data Science/Capstone05/Decisiontree.pkl', 'rb') as files:
